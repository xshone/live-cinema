...
function FeatureCard({
    ...
    return (
        ...
        >
            ...
            <h3 className="font-black text-2xl uppercase tracking-tight border-t-4 border-black pt-4">{title}</h3>
    ...
    return (
        <div className="relative w-full max-w-sm mx-auto select-none">
            ...
            <div className="relative border-4 border-black shadow-neo-xl bg-black aspect-video overflow-hidden">
                ...
                {/* Screen text */}
                <div className="absolute inset-0 flex items-center justify-center">
                    <p className="font-black text-white text-lg uppercase tracking-widest opacity-80">Press START</p>
                </div>
                {/* LIVE badge */}
...
function StepCard({ num, title, desc }: { num: string; title: string; desc: string }) {
    return (
        <div className="flex gap-6 items-start">
            <span className="font-black text-6xl leading-none text-black shrink-0 w-16 text-right">{num}</span>
...
export default function HomePage() {
    return (
        <main className="font-space bg-neo-bg min-h-screen overflow-x-hidden">
            {/* ── Top marquee ─────────────────────────────────────────── */}
            <MarqueeStrip bg="#000" text="COM CINEMA — 虚拟影院" textColor="#FFD93D" />
                ...
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="bg-[#FFD93D] border-4 border-black px-4 py-2 shadow-neo-sm -rotate-1">
                            <span className="font-black text-lg uppercase tracking-tighter text-black">COM CINEMA</span>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6 py-16 lg:py-24 grid lg:grid-cols-5 gap-12 items-center">
                    ...
                    <div className="lg:col-span-3 space-y-8">
                        ...
                        <div className="space-y-2">
                            ...
                            {/* "虚拟影院" — yellow block, rotated sticker */}
                        ...
                        <p className="font-bold text-xl leading-relaxed text-black max-w-lg border-l-4 border-[#FF6B6B] pl-5">
                            沉浸式 3D 虚拟影院体验。HLS 实时直播流，Three.js 构建的真实影厅， 空间环绕音效，WASD
                            自由飞行视角。
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            {[
                                { val: "5 ROWS", label: "观影排数" },
                                { val: "15 COLS", label: "每排座位" },
                                { val: "HLS", label: "直播协议" },
                                { val: "3D", label: "空间音效" },
                            ].map(({ val, label }) => (
            ...
            {/* ── Middle marquee ──────────────────────────────────────── */}
            <MarqueeStrip bg="#FFD93D" text="免费体验 · FREE TO PLAY · 开放访问 · OPEN ACCESS" textColor="#000" />
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-end gap-4 mb-16">
                        <div className="bg-[#FF6B6B] border-4 border-[#FF6B6B] px-5 py-2 shadow-neo-white-md -rotate-1 inline-block">
                            <span className="font-black text-sm uppercase tracking-[0.2em] text-black">FEATURES</span>
                        </div>
                        <h2
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <FeatureCard
                            number="01"
                            title="HLS 直播流"
                            desc="支持 HTTP Live Streaming 协议，接入实时视频源，在影厅大屏上同步播放直播内容。"
                            bg="#FF6B6B"
                            rotate="-rotate-1"
                        />
                        <FeatureCard
                            number="02"
                            title="3D 空间音效"
                            desc="Three.js PositionalAudio 驱动，声音随距离衰减，越靠近屏幕声音越大，沉浸感拉满。"
                            bg="#C4B5FD"
                            rotate="rotate-1"
                        />
                        <FeatureCard
                            number="03"
                            title="自由飞行视角"
                            desc="WASD 键盘控制 + 鼠标锁定，可在整个影厅内自由飞行探索，Shift 键加速冲刺。"
                            bg="#FFD93D"
                            rotate="-rotate-1"
                        />
                    </div>
                ...
                <div className="max-w-5xl mx-auto px-6">
                    <div className="flex flex-col sm:flex-row sm:items-end gap-4 mb-16">
                        <div className="bg-[#C4B5FD] border-4 border-black px-5 py-2 shadow-neo-md rotate-1 inline-block">
                            <span className="font-black text-sm uppercase tracking-[0.2em] text-black">HOW TO</span>
                        </div>
                        <h2
                    ...
                    <div className="bg-white border-4 border-black shadow-neo-xl p-8 lg:p-12 space-y-10">
                        <StepCard
                            num="01"
                            title="点击「立即进入」"
                            desc="点击首页的红色按钮，进入全屏 3D 影院场景，等待 Three.js 渲染引擎初始化完成。"
                        />
                        <div className="border-t-4 border-black" />
                        <StepCard
                            num="02"
                            title="点击「开始播放」"
                            desc="点击屏幕下方的播放按钮，连接 HLS 直播流，视频将显示在影厅的弧形大屏上，同时激活空间音效。"
                        />
                        <div className="border-t-4 border-black" />
                        <StepCard
                            num="03"
                            title="自由探索影厅"
                            desc="点击 Three.js 画面锁定鼠标，使用 WASD 移动，鼠标控制视角方向，E/Q 上下飞行，Shift 加速冲刺。双击进入全屏模式。"
                        />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="font-bold text-white/60 text-sm max-w-xs leading-relaxed">
                                基于 Three.js + Next.js 构建的沉浸式虚拟 3D 影院体验平台。
                            </p>
                        </div>
                    ...
                    <div className="border-t-2 border-white/10 mt-10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-white/40 text-xs uppercase tracking-widest">LIVE NOW</span>
                        </div>
                    </div>
                </div>
            </footer>
